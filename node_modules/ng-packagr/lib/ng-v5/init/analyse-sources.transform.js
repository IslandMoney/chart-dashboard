...
function analyseEntryPoint(graph, entryPoint, entryPoints) {
    ...
    const tsConfigOptions = Object.assign({}, entryPoint.data.tsConfig.options, { skipLibCheck: true, resolveJsonModule: false, moduleResolution: ts.ModuleResolutionKind.Classic, types: [] });
